...
if(EXISTS "C:/Users/federico/My project (3)/ARAP_implementation/build/_deps/eigen-subbuild/eigen-populate-prefix/src/eigen-populate-stamp/eigen-populate-gitclone-lastrun.txt" AND EXISTS "C:/Users/federico/My project (3)/ARAP_implementation/build/_deps/eigen-subbuild/eigen-populate-prefix/src/eigen-populate-stamp/eigen-populate-gitinfo.txt" AND
  ...
  message(STATUS
    ...
    "'C:/Users/federico/My project (3)/ARAP_implementation/build/_deps/eigen-subbuild/eigen-populate-prefix/src/eigen-populate-stamp/eigen-populate-gitclone-lastrun.txt'"
  )
  return()
endif()

execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "C:/Users/federico/My project (3)/ARAP_implementation/build/_deps/eigen-src"
  RESULT_VARIABLE error_code
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: 'C:/Users/federico/My project (3)/ARAP_implementation/build/_deps/eigen-src'")
endif()
...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe"
          checkout "tags/3.4.0" --
  WORKING_DIRECTORY "C:/Users/federico/My project (3)/ARAP_implementation/build/_deps/eigen-src"
  RESULT_VARIABLE error_code
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: 'C:/Users/federico/My project (3)/ARAP_implementation/build/_deps/eigen-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: 'C:/Users/federico/My project (3)/ARAP_implementation/build/_deps/eigen-subbuild/eigen-populate-prefix/src/eigen-populate-stamp/eigen-populate-gitclone-lastrun.txt'")
endif()
